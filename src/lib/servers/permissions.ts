...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    perms: [
      ...
      { key: "settings.egg", label: "Startup (image + variables)" },
      {
        key: "settings.startup_command",
        label: "Modifier la ligne de démarrage",
      },
  ...
  },
  {
    ...
    label: "Activité",
    perms: [
      { key: "activity.read", label: "Voir le journal d'activité" },
    ],
  },
] as const;
